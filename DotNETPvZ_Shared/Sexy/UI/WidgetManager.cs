	...
	internal class WidgetManager : WidgetContainer
	{
		...
		public bool MouseMove(int x, int y)
		{
			...
			if (this.mFocusWidget != null)
			{
				...
				TPoint tpoint = this.mFocusWidget.GetAbsPos();

				CGPoint p = new CGPoint(x, y);
				CGMaths.CGPointTranslate(ref p, -tpoint.mX, -tpoint.mY);
				this.mFocusWidget.MouseMove((int)p.mX, (int)p.mY);
