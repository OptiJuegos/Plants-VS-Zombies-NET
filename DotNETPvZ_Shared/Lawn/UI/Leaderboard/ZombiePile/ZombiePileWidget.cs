			...
			if (!this.mLoadedFriends)
			{
				...
				if (num >= 0)
				{
					...
					while (!flag)
					{
						...
						{
							Object leaderboardGamer = LeaderBoardComm.GetLeaderboardGamer(signedInGamerIndex + num3, LeaderboardState.Adventure);
						...
						{
							Object leaderboardGamer2 = LeaderBoardComm.GetLeaderboardGamer(signedInGamerIndex - num3, LeaderboardState.Adventure);
