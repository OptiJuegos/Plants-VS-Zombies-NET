	...
	internal class AlmanacDialog : LawnDialog
	{
		...
		public void DrawIndex(Graphics g)
		{
			...
			if (this.mPlant != null)
			{
				...
				TodCommon.TodDrawString(g, "[VIEW_PLANTS]", Constants.Almanac_IndexPlantTextPos.X - 2, Constants.Almanac_IndexPlantTextPos.Y + 8, Resources.FONT_DWARVENTODCRAFT15, Constants.YellowFontColour, DrawStringJustification.DS_ALIGN_CENTER, almanac_Text_Scale);
				@new.PrepareForReuse();
			}
			if (this.mZombie != null)
			{
				...
				GlobalStaticVars.mGlobalContent.SetLocalizeFont(Loc_Font.kYahei);
				TodCommon.TodDrawString(g, "[VIEW_ZOMBIES]", Constants.Almanac_IndexZombieTextPos.X, Constants.Almanac_IndexZombieTextPos.Y + 8, Resources.FONT_DWARVENTODCRAFT15, Constants.GreenFontColour, DrawStringJustification.DS_ALIGN_CENTER, almanac_Text_Scale);
		...
		public void DrawZombies(Graphics g)
		{
			...
			if (this.mZombie != null && !this.ZombieHasSilhouette(this.mZombie.mZombieType))
			{
				...
				TRect zombieClipRect = Constants.Almanac_ZombieClipRect;
				@new.SetClipRect(ref zombieClipRect);
			...
			GlobalStaticVars.mGlobalContent.SetLocalizeFont(Loc_Font.kYahei);
			TodCommon.TodDrawString(g, theText, Constants.Almanac_NamePosition.X, Constants.Almanac_NamePosition.Y + 14, Resources.FONT_DWARVENTODCRAFT15, new SexyColor(0, 196, 0), Constants.Almanac_ItemName_MaxWidth, DrawStringJustification.DS_ALIGN_CENTER);
		...
		public void DrawPlants(Graphics g)
		{
			...
			GlobalStaticVars.mGlobalContent.SetLocalizeFont(Loc_Font.kYahei);
			TodCommon.TodDrawString(g, nameString, Constants.Almanac_NamePosition.X, Constants.Almanac_NamePosition.Y + 14, Resources.FONT_DWARVENTODCRAFT15, new SexyColor(213, 159, 43), Constants.Almanac_ItemName_MaxWidth, DrawStringJustification.DS_ALIGN_CENTER);
			TRect rect = this.mDescriptionScrollWidget.GetRect();
			rect.Inflate((int)Constants.InvertAndScale(6f), (int)Constants.InvertAndScale(6f));
		...
		public static bool[] gZombieDefeated = new bool[(int)ZombieType.NUM_ZOMBIE_TYPES];
