...
namespace Lawn
{
	...
	internal class DescriptionWidget : Widget
	{
		...
		public override void Draw(Graphics g)
		{
			...
			TodStringFile.TodDrawStringWrapped(g, this.mText, new TRect(-14, -14, this.mWidth - this.SCROLLBAR_PAD, this.mHeight), Resources.FONT_BRIANNETOD12, new SexyColor(40, 50, 90), DrawStringJustification.DS_ALIGN_LEFT);
			g.EndHardwareClip();
		}
