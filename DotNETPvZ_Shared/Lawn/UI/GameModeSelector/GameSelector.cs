...
namespace Lawn
{
    ...
    internal class GameSelector : Widget, ButtonListener, StoreListener, AlmanacListener, MiniGamesWidgetListener, QuickPlayWidgetListener
    {
        ...
        public GameSelector(LawnApp theApp)
        {
            ...
            mZenGardenButton.Resize(Constants.MAIN_MENU_ORIGIN_X + Constants.GameSelector_ZenGardenButton_X - 30, Constants.GameSelector_ZenGardenButton_Y, AtlasResources.IMAGE_REANIM_SELECTORSCREEN_ZENGARDEN.mWidth, AtlasResources.IMAGE_REANIM_SELECTORSCREEN_ZENGARDEN.mHeight);
            ...
            mStoreButton.Resize(Constants.MAIN_MENU_ORIGIN_X + Constants.GameSelector_StoreButton_X - 70, Constants.GameSelector_StoreButton_Y, AtlasResources.IMAGE_SELECTORSCREEN_STORE.mWidth, AtlasResources.IMAGE_SELECTORSCREEN_STORE.mHeight);
            ...
            this.mAchievementsButton = GameButton.MakeNewButton(117, this, "", null, AtlasResources.IMAGE_REANIM_SELECTORSCREEN_ACHIEVEMENTS_BUTTON, AtlasResources.IMAGE_REANIM_SELECTORSCREEN_ACHIEVEMENTS_HIGHLIGHT, AtlasResources.IMAGE_REANIM_SELECTORSCREEN_ACHIEVEMENTS_HIGHLIGHT);
            ...
            this.mSelectedQuickplayButtonId = GameSelectorButtons.GameSelector_MiniGames;
            this.ToggleGameButton((int)this.mSelectedQuickplayButtonId);
            this.mMoreGamesListWidget = new MoreGamesListWidget(this.mApp);

            this.mUserButton = GameButton.MakeButton((int)GameSelectorButtons.GameSelector_UserDialog, this, "[GAMESELECTOR_SWITCH_USER]");
            ...
            this.mChallengePageSurvivalButton = GameButton.MakeButton((int)GameSelectorButtons.GameSelector_ChallengePageSurvival, this, "[GAMESELECTOR_SURVIVAL]");
            ...
            this.mChallengePageLimboButton = GameButton.MakeButton((int)GameSelectorButtons.GameSelector_ChallengePageLimbo, this, "[GAMESELECTOR_LIMBO]");
            ...
            this.AddWidget(this.mUserButton);
        ...
        public override void DrawOverlay(Graphics g)
        {
            ...
            if (this.mApp.mPlayerInfo != null && !string.IsNullOrEmpty(this.mApp.mPlayerInfo.mName) && (this.mSignState == SelectorSignState.SIGN_DOWN || this.mSignState == SelectorSignState.SIGN_MOVING_DOWN))
            {
                ...
                sexyTransform2D2.Translate(28f, 8f);
            ...
            if (this.mApp.mPlayerInfo != null)
            {
                bool flag1 = this.mApp.mPlayerInfo.mLastSeenMoreGames < this.mApp.mProfileMgr.mLastMoreGamesUpdate;
            }
        ...
        public override bool BackButtonPress()
        {
            switch (this.state)
            {
                case GameSelector.GameSelectorScreenState.Main:
                    this.mApp.ConfirmQuit();//this.mApp.WantsToExit = true;
                    break;
        ...
        public override void Update()
        {
            ...
            if (this.mQuickplaySlideCounter > 0)
            {
                ...
                this.mQuickplaySlideCounter -= 1;
                if (this.mQuickplaySlideCounter == 0 && this.mRetractingQuickplay && (this.mSlideCounter == 0 || this.mDestX == -Constants.QUICKPLAY_ORIGIN_X))
                {
            ...
            if (this.mSignState == SelectorSignState.SIGN_DOWN)
            {
                if (reanimation.mLoopCount > 0)
                {
                    ...
                    if (this.mApp.mPlayerInfo != null && this.mApp.mPlayerInfo.mNeedsMessageOnGameSelector)
                    {
                        ...
                        this.mApp.LawnMessageBox(Dialogs.DIALOG_MESSAGE, "[ADVENTURE_COMPLETE_HEADER]", "[ADVENTURE_COMPLETE_BODY]", "[DIALOG_BUTTON_OK]", "", 3, null);
                    }
                }
            }
            ...
            if (this.mInUserDialog && this.mApp.GetDialog(Dialogs.DIALOG_CREATEUSER) == null)
            {
                this.mInUserDialog = false;
                this.LowerSign();
            }
        ...
        public virtual void ButtonDepress(int theId)
        {
            ...
            if ((GameSelectorButtons)theId == GameSelectorButtons.GameSelector_Quickplay && this.mQuickplayLocked)
            {
                this.mApp.LawnMessageBox(Dialogs.DIALOG_MESSAGE, "[MODE_LOCKED]", "[QUICKPLAY_LOCKED_MESSAGE]", "[DIALOG_BUTTON_OK]", "", 3, null);
                return;
            }
            this.state = GameSelector.GameSelectorScreenState.Main;
            switch ((GameSelectorButtons)theId)
            {
                case GameSelectorButtons.GameSelector_Adventure:
                    this.mApp.KillGameSelector();
                    this.ClickedAdventure();
                    return;
                case GameSelectorButtons.GameSelector_Quickplay:
                    ...
                    return;
                case GameSelectorButtons.GameSelector_QuickplayDay:
                case GameSelectorButtons.GameSelector_QuickplayNight:
                case GameSelectorButtons.GameSelector_QuickplayPool:
                case GameSelectorButtons.GameSelector_QuickplayFog:
                case GameSelectorButtons.GameSelector_QuickplayRoof:
                case GameSelectorButtons.GameSelector_QuickplayBonus:
                    if ((GameSelectorButtons)theId != this.mSelectedQuickplayButtonId)
                    {
                        this.ToggleGameButton((int)this.mSelectedQuickplayButtonId);
                        this.ToggleGameButton(theId);
                        this.mSelectedQuickplayButtonId = (GameSelectorButtons)theId;
                        this.RetractQuickPlayWidget();
                        return;
                    }
                    break;
                case GameSelectorButtons.GameSelector_QuickplayBack:
                    this.RetractQuickPlayWidget();
                    this.SlideTo(-Constants.MAIN_MENU_ORIGIN_X, 0);
                    this.state = GameSelector.GameSelectorScreenState.Main;
                    return;
                case GameSelectorButtons.GameSelector_Options:
                    this.mApp.DoNewOptions(true);
                    return;
                case GameSelectorButtons.GameSelector_Help:
                    this.mApp.KillGameSelector();
                    this.mApp.ShowAwardScreen(AwardType.AWARD_HELP_ZOMBIE_NOTE, false);
                    return;
                case GameSelectorButtons.GameSelector_Quit:
                    this.mApp.ConfirmQuit();
                    return;
                case GameSelectorButtons.GameSelector_Store:
                    this.mDoNewGameAfterStore = false;
                    this.mApp.ShowStoreScreen(this);
                    return;
                case GameSelectorButtons.GameSelector_UnlockGame:
                    this.mApp.BuyGame();
                    return;
                case GameSelectorButtons.GameSelector_Almanac:
                    this.mApp.DoAlmanacDialog(SeedType.SEED_NONE, ZombieType.ZOMBIE_INVALID, this);
                    return;
                case GameSelectorButtons.GameSelector_MoreGames:
                    ...
                    return;
                case GameSelectorButtons.GameSelector_MoreGamesBack:
                    this.mMoreGamesBackButton.mVisible = false;
                    this.mMoreGamesBackButton.mDisabled = true;
                    ...
                    this.state = GameSelector.GameSelectorScreenState.Main;
                    return;
                case GameSelectorButtons.GameSelector_Achievements:
                    ...
                    return;
                case GameSelectorButtons.GameSelector_AchievementsBack:
                    ...
                    return;
                case GameSelectorButtons.GameSelector_UpdateAvailable:
                    break;
                case GameSelectorButtons.GameSelector_Leaderboards:
                    this.mApp.KillGameSelector();
                    this.mApp.ShowLeaderboardScreen();
                    return;
                case GameSelectorButtons.GameSelector_MiniGames:
                case GameSelectorButtons.GameSelector_Vasebreaker:
                case GameSelectorButtons.GameSelector_IZombie:
                    if ((GameSelectorButtons)theId != this.mSelectedQuickplayButtonId)
                    {
                        this.ToggleGameButton((int)this.mSelectedQuickplayButtonId);
                        this.ToggleGameButton(theId);
                    ...
                    this.state = GameSelector.GameSelectorScreenState.MoreGames;
                    break;
                case GameSelectorButtons.GameSelector_ZenGarden:
                    this.mApp.KillGameSelector();
                    this.mApp.PreNewGame(GameMode.GAMEMODE_CHALLENGE_ZEN_GARDEN, false);
                    return;
                case GameSelectorButtons.GameSelector_UserDialog:
                    this.mApp.DoUserDialog();
                    return;
                case GameSelectorButtons.GameSelector_ChallengePageSurvival:
                    this.mApp.KillGameSelector();
                    this.mApp.ShowChallengeScreen(ChallengePage.CHALLENGE_PAGE_SURVIVAL);
                    return;
                case GameSelectorButtons.GameSelector_ChallengePageLimbo:
                    this.mApp.KillGameSelector();
                    this.mApp.ShowChallengeScreen(ChallengePage.CHALLENGE_PAGE_LIMBO);
                    return;
                default:
                    return;
            }
        ...
        public override void KeyChar(SexyChar theChar)
        {
            if (mApp.mPlayerInfo.mHasUsedCheatKeys)
            {
                if (theChar.value_type == 'u' && this.mApp.mPlayerInfo != null)
                {
                    ...
                    this.mApp.mPlayerInfo.mMiniGamesUnlocked = 19;
                    this.mApp.mPlayerInfo.mIZombieUnlocked = 10;
                    this.mApp.mPlayerInfo.mVasebreakerUnlocked = 10;
                    for (int i = 0; i < 200; i++)
                    {
        ...
        public void ClickedAdventure()
        {
            ...
            if (this.ShouldDoZenTutorialBeforeAdventure())
            {
                this.mApp.PreNewGame(GameMode.GAMEMODE_CHALLENGE_ZEN_GARDEN, false);
        ...
        public bool ShouldDoZenTutorialBeforeAdventure()
        {
        ...
        public void MoveToQuickplay(bool theDoFadeIn, GameSelectorButtons theButton)
        {
            ...
            if (theButton != (GameSelectorButtons)this.mSelectedQuickplayButtonId)
            {
                ...
                this.mSelectedQuickplayButtonId = theButton;
                this.PopulateQuickPlayWidget();
        ...
        public DialogButton mUserButton;
        ...
        public GameSelectorButtons mSelectedQuickplayButtonId;
