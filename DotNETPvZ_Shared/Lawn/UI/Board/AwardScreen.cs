...
namespace Lawn
{
	...
	internal class AwardScreen : Widget, AlmanacListener, StoreListener, ButtonListener
	{
		...
		public AwardScreen(LawnApp theApp, AwardType theAwardType, bool theShowAchievements)
		{
			...
			this.mMenuButton.mTextOffsetY = (int)Constants.InvertAndScale(0f);
			this.mMenuButton.mTextOffsetX = -8;
		...
		public override void Resize(int theX, int theY, int theWidth, int theHeight)
		{
			...
			this.mStartButton.mTextOffsetY = 7;
		...
		public override void Draw(Graphics g)
		{
			...
			else if (this.mAwardType != AwardType.AWARD_ACHIEVEMENT_ONLY)
			{
				...
				else if (level == 10)
				{
					...
					TodCommon.TodDrawString(g, "[FOUND_NOTE]", Constants.AwardScreen_Note_Message.X + num2, Constants.AwardScreen_Note_Message.Y + num, Resources.FONT_DWARVENTODCRAFT15, new SexyColor(255, 200, 0, 255), DrawStringJustification.DS_ALIGN_CENTER);
				}
				else if (level == 15)
				{
		...
		public void DrawBottom(Graphics g, string theTitle, string theAward, string theMessage)
		{
			...
			float localizedFontScale = GlobalStaticVars.mGlobalContent.GetLocalizedFontScale();
			GlobalStaticVars.mGlobalContent.SetLocalizedFontSize(localizedFontSize + 2);
			GlobalStaticVars.mGlobalContent.SetLocalizedFontScale(localizedFontScale + 0.25f);
			TodCommon.TodDrawString(g, theTitle, Constants.AwardScreen_TitlePos.X, Constants.AwardScreen_TitlePos.Y + 15, Resources.FONT_DWARVENTODCRAFT18, Constants.GreenFontColour, Constants.BOARD_WIDTH - 60, DrawStringJustification.DS_ALIGN_CENTER);
			GlobalStaticVars.mGlobalContent.SetLocalizedFontSize(localizedFontSize);
			GlobalStaticVars.mGlobalContent.SetLocalizedFontScale(localizedFontScale);
			...
			if (!theAward.empty())
			{
				...
				GlobalStaticVars.mGlobalContent.SetLocalizeFont(Loc_Font.kYahei);
				TodCommon.TodDrawString(g, theAward, Constants.AwardScreen_BottomMessage_Pos.X, Constants.AwardScreen_BottomMessage_Pos.Y + 24, Resources.FONT_DWARVENTODCRAFT18, Constants.YellowFontColour, DrawStringJustification.DS_ALIGN_CENTER);
