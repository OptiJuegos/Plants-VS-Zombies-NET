...
namespace Lawn
{
	...
	internal class ContinueDialog : LawnDialog
	{
		...
		public override void Resize(int theX, int theY, int theWidth, int theHeight)
		{
			...
			int num = AtlasResources.IMAGE_BUTTON_LEFT.mWidth + AtlasResources.IMAGE_BUTTON_MIDDLE.mWidth * 2 + AtlasResources.IMAGE_BUTTON_RIGHT.mWidth;
		...
		public override void ButtonDepress(int theId)
		{
			...
			if (theId == 1)
			{
				...
				{
					LawnDialog lawnDialog = this.mApp.DoDialog(Dialogs.DIALOG_RESTARTCONFIRM, true, "[RESTART_LEVEL_HEADER]", "[RESTART_LEVEL]", "", 2);
				...
				LawnDialog lawnDialog2 = this.mApp.DoDialog(Dialogs.DIALOG_RESTARTCONFIRM, true, "[NEW_GAME_HEADER]", "[NEW_GAME]", "", 2);
