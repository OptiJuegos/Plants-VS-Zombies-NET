...
namespace Lawn
{
    ...
    internal class StoreScreen : Dialog
    {
        ...
        public override void Update()
        {
            ...
            if (this.mApp.mCrazyDaveState != CrazyDaveState.CRAZY_DAVE_OFF && this.mApp.mCrazyDaveState != CrazyDaveState.CRAZY_DAVE_ENTERING)
            {
                ...
                else if (!this.mBubbleClickToContinue)
                {
                    ...
                    {
                        this.mAmbientSpeechCountDown -= 1;
        ...
        public override void Draw(Graphics g)
        {
            ...
            int moneyStringXOffset = storeScreen_Coinbank_X + Constants.StoreScreen_Coinbank_TextOffset.X - Resources.FONT_CONTINUUMBOLD14.StringWidth(moneyString);
            g.DrawString(moneyString, moneyStringXOffset + 5 * moneyString.length(), storeScreen_Coinbank_Y + 6 + Constants.StoreScreen_Coinbank_TextOffset.Y);
        }
        ...
        public void PurchaseItem(StoreItem theItemType)
        {
            ...
            {
                this.mApp.DoDialog(Dialogs.DIALOG_NOT_ENOUGH_MONEY, true, "[NOT_ENOUGH_MONEY]", "[CANNOT_AFFORD_ITEM]", "[DIALOG_BUTTON_OK]", 3);
                return;
            }
            ...
            mApp.AddDialog(Dialogs.DIALOG_STORE_PURCHASE, confirmPurchaseDialog);
        }


        public void PurchasePendingItem()
        {
            mApp.KillDialog(Dialogs.DIALOG_STORE_PURCHASE);
            ...
            if (storeItem == StoreItem.STORE_ITEM_PACKET_UPGRADE)
            {
                ...
                LawnDialog lawnDialog = this.mApp.DoDialog(Dialogs.DIALOG_UPGRADED, true, "[MORE_SLOTS]", theDialogLines, "[DIALOG_BUTTON_OK]", 3);
        ...
        {
            this.mApp.KillDialog(Dialogs.DIALOG_VISIT_TREE_OF_WISDOM);
            if (this.mApp.mSeedChooserScreen != null)
            {
                this.mApp.mSeedChooserScreen.UpdateAfterPurchase();
            }
