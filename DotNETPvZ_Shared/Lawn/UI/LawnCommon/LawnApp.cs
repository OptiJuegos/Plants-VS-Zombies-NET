...
namespace Lawn
{
    ...
    internal class LawnApp : SexyAppBase
    {
        ...
        public bool KillNewOptionsDialog()
        {
            ...
            this.KillDialog(Dialogs.DIALOG_NEWOPTIONS);
            return true;
        }
        ...
        public bool KillLeaderboardDialog()
        {
            ...
            this.KillDialog(Dialogs.DIALOG_LEADERBOARD);
        ...
        public void ConfirmQuit()
        {
            ...
            LawnDialog lawnDialog = this.DoDialog(Dialogs.DIALOG_QUIT, true, theDialogHeader, theDialogLines, "", 2);
        ...
        {
            this.KillDialog(Dialogs.DIALOG_CREATEUSER);
            NewUserDialog newUserDialog = new NewUserDialog(this, false, !isOnlyUser);
            LawnApp.CenterDialog(newUserDialog, newUserDialog.mWidth, newUserDialog.mHeight);
            base.AddDialog(Dialogs.DIALOG_CREATEUSER, newUserDialog);
        ...
        public void FinishCreateUserDialog(bool isYes)
        {
            ...
            string text = newUserDialog.mNameEditWidget.mString;
            ...
            {
                this.DoDialog(Dialogs.DIALOG_CREATEUSERERROR, true, "[ENTER_YOUR_NAME]", theDialogLines, "[DIALOG_BUTTON_OK]", 3);
                return;
            }
            if (!isYes)
            {
            ...
            if (playerInfo == null)
            {
                this.DoDialog(Dialogs.DIALOG_CREATEUSERERROR, true, "[NAME_CONFLICT]", "[ENTER_UNIQUE_PLAYER_NAME]", "[DIALOG_BUTTON_OK]", 3);
                return;
            }
        ...
        {
            this.KillDialog(Dialogs.DIALOG_CONFIRMDELETEUSER);
            this.DoDialog(Dialogs.DIALOG_CONFIRMDELETEUSER, true, "[ARE_YOU_SURE]", Common.StrFormat_(TodStringFile.TodStringTranslate("[DELETE_USER_WARNING]"), theName), "", 1);
        }
        ...
        {
            this.KillDialog(Dialogs.DIALOG_RENAMEUSER);
            ...
            base.AddDialog(Dialogs.DIALOG_RENAMEUSER, newUserDialog);
        }
        ...
        public void FinishRenameUserDialog(bool isYes)
        {
            ...
            NewUserDialog newUserDialog = (NewUserDialog)base.GetDialog(Dialogs.DIALOG_RENAMEUSER);
            ...
            {
                this.DoDialog(Dialogs.DIALOG_RENAMEUSERERROR, true, "[NAME_CONFLICT]", "[ENTER_UNIQUE_PLAYER_NAME]", "[DIALOG_BUTTON_OK]", 3);
                return;
            }
            this.mProfileMgr.Save();
            if (flag)
        ...
        public void FinishNameError(Dialogs theId)
        {
        ...
        public void FinishRestartConfirmDialog()
        {
            ...
            this.KillDialog(Dialogs.DIALOG_CONTINUE);
            this.KillDialog(Dialogs.DIALOG_RESTARTCONFIRM);
            this.KillBoard();
            this.PreNewGame(this.mGameMode, false);
        }
        ...
        {
            this.KillDialog(Dialogs.DIALOG_CONFIRM_IN_GAME_RESTART);
            if (isYes)
            {
                this.mMusic.StopAllMusic();
        ...
        {
            this.KillDialog(Dialogs.DIALOG_ABOUT);
        }


        public void FinishRestartWarningDialog(bool isYes)
        {
            this.KillDialog(Dialogs.RESTART_WARNING);
        }


        public void FinishPacketSlotPurchaseDialog(bool isYes)
        {
            this.KillDialog(Dialogs.DIALOG_PURCHASE_PACKET_SLOT);
            if (isYes)
            {
        ...
        {
            this.KillDialog(Dialogs.DIALOG_TIMESUP);
        }
        ...
        public void FinishPlantSale(bool isYes)
        {
            ...
            this.KillDialog(Dialogs.DIALOG_ZEN_SELL);
        }
        ...
        public void PreNewGame(GameMode theGameMode, bool theLookForSavedGame, bool checkForTutorialCompletion)
        {
            ...
            {
                LawnDialog theDialog = this.DoDialog(Dialogs.DIALOG_SKIP_TUTORIAL, true, string.Empty, "[SKIP_TUTORIAL_MESSAGE]", string.Empty, 1);
        ...
        {
            LawnDialog lawnDialog = this.DoDialog(Dialogs.DIALOG_CONFIRM_BACK_TO_MAIN, true, "[LEAVE_GAME_HEADER]", "[LEAVE_GAME]", "", 1);
        ...
        public void DoNewOptions(bool theFromGameSelector)
        {
            ...
            base.AddDialog(Dialogs.DIALOG_NEWOPTIONS, newOptionsDialog);
        ...
        public void ShowLeaderboardDialog(LeaderBoardType aType)
        {
            ...
            base.AddDialog(Dialogs.DIALOG_LEADERBOARD, leaderboardDialog);
        ...
        {
            this.DoDialog(Dialogs.DIALOG_REGISTER_ERROR, true, "[INVALID_CODE]", "[INVALID_CODE_MESSAGE]", "[DIALOG_BUTTON_OK]", 3);
        }
        ...
        public void DoLockedAchievementDialog(AchievementId theId)
        {
            ...
            LawnDialog lawnDialog = this.DoDialog(Dialogs.DIALOG_ACHIEVEMENT_LOCKED, true, "[ACHIEVEMENT_UNLOCKED]", theDialogLines, "", 2);
        ...
        {
            LawnDialog lawnDialog = this.DoDialog(Dialogs.DIALOG_PREGAME_NAG, true, "[REGISTER_HEADER]", "[REGISTER]", "", 2);
        ...
        public void DoContinueDialog()
        {
            ...
            base.AddDialog(Dialogs.DIALOG_CONTINUE, continueDialog);
        }
        ...
        public void DoPauseDialog()
        {
            ...
            this.FinishModelessDialogs();
            LawnDialog lawnDialog = this.DoDialog(Dialogs.DIALOG_PAUSED, true, "[GAME_PAUSED]", "", "[RESUME_GAME]", 3);
        ...
        public LawnDialog DoDialog(Dialogs theDialogId, bool isModal, string theDialogHeader, string theDialogLines, string theDialogFooter, int theButtonMode)
        {
            ...
            LawnDialog lawnDialog = new LawnDialog(this, null, (int)theDialogId, isModal, theDialogHeader, theDialogLines, theDialogFooter, theButtonMode);
        ...
        public LawnDialog DoDialogDelay(Dialogs theDialogId, bool isModal, string theDialogHeader, string theDialogLines, string theDialogFooter, int theButtonMode)
        {
            LawnDialog lawnDialog = new LawnDialog(this, null, (int)theDialogId, isModal, theDialogHeader, theDialogLines, theDialogFooter, theButtonMode);
            base.DoDialog(lawnDialog, theDialogId);
        ...
        public override void Shutdown()
        {
            ...
            if (!this.mShutdown)
            {
                for (int i = 0; i < (int)Dialogs.NUM_DIALOGS; i++)
                {
                    this.KillDialog((Dialogs)i);
                }
                if (this.mBoard != null)
                {
                    this.mBoardResult = BoardResult.BOARDRESULT_QUIT_APP;
        ...
        public override bool KillDialog(Dialogs theDialogId)
        {
        ...
        {
            if (theId % 10000 >= 2000 && theId % 10000 < 3000)  // Positive Selection
            {
                int backFromDialogId = theId - 2000;
                switch ((Dialogs)backFromDialogId)
                {
                    case Dialogs.DIALOG_NEW_GAME:
                        this.KillDialog(0);
                        this.ShowGameSelector();
                        return;
                    case Dialogs.DIALOG_OPTIONS:
                    case Dialogs.DIALOG_ALMANAC:
                    case Dialogs.DIALOG_STORE:
                    case Dialogs.DIALOG_CHECKING_UPDATES:
                    case Dialogs.DIALOG_REGISTER_ERROR:
                    case Dialogs.DIALOG_COLORDEPTH_EXP:
                    case Dialogs.DIALOG_OPENURL_WAIT:
                    case Dialogs.DIALOG_OPENURL_FAIL:
                    case Dialogs.DIALOG_HIGH_SCORES:
                    case Dialogs.DIALOG_GAME_OVER:
                    case Dialogs.DIALOG_LEVEL_COMPLETE:
                    case Dialogs.DIALOG_THANKS_FOR_REGISTERING:
                    case Dialogs.DIALOG_NOT_ENOUGH_MONEY:
                    case Dialogs.DIALOG_UPGRADED:
                    case Dialogs.DIALOG_NO_UPGRADE:
                    case Dialogs.DIALOG_CHEATERROR:
                    case Dialogs.DIALOG_CONTINUE:
                    case Dialogs.DIALOG_GETREADY:
                    case Dialogs.DIALOG_CONFIRMPURCHASE:
                    case Dialogs.DIALOG_CONFIRMSELL:
                    case Dialogs.DIALOG_VIRTUALHELP:
                    case Dialogs.DIALOG_JUMPAHEAD:
                    case Dialogs.DIALOG_CRAZY_DAVE:
                    case Dialogs.DIALOG_IMITATER:
                    case Dialogs.DIALOG_UPSELL:
                    case Dialogs.DIALOG_UPDATE_NOW:
                    case Dialogs.DIALOG_MORE_GAMES:
                        this.KillDialog((Dialogs)backFromDialogId);
                        return;
                    ...
                    case Dialogs.DIALOG_CONFIRM_UPDATE_CHECK:
                        this.KillDialog(Dialogs.DIALOG_CONFIRM_UPDATE_CHECK);
                        this.CheckForUpdates();
                        return;
                    case Dialogs.DIALOG_QUIT:
                        this.KillDialog(Dialogs.DIALOG_QUIT);
                        this.CloseRequestAsync();
                        this.WantsToExit = true;
                        return;
                    case Dialogs.DIALOG_NAG:
                        this.KillDialog(Dialogs.DIALOG_NAG);
                        this.DoRegister();
                        return;
                    case Dialogs.DIALOG_INFO:
                        this.KillDialog(Dialogs.DIALOG_INFO);
                        return;
                    case Dialogs.DIALOG_PAUSED:
                        this.KillDialog(Dialogs.DIALOG_PAUSED);
                        return;
                    case Dialogs.DIALOG_NO_MORE_MONEY:
                        this.KillDialog(Dialogs.DIALOG_NO_MORE_MONEY);
                        this.mBoard.AddSunMoney(100);
                        return;
                    case Dialogs.DIALOG_BONUS:
                        this.KillDialog(Dialogs.DIALOG_BONUS);
                        return;
                    case Dialogs.DIALOG_CONFIRM_BACK_TO_MAIN:
                        this.KillDialog(Dialogs.DIALOG_CONFIRM_BACK_TO_MAIN);
                        this.mBoardResult = BoardResult.BOARDRESULT_QUIT;
                        this.mBoard.TryToSaveGame();
                        this.DoBackToMain();
                        return;
                    case Dialogs.DIALOG_CONFIRM_IN_GAME_RESTART:
                        this.FinishInGameRestartConfirmDialog(true);
                        return;
                    case Dialogs.DIALOG_CHOOSER_WARNING:
                    case Dialogs.DIALOG_MESSAGE:
                        this.KillDialog((Dialogs)backFromDialogId);
                    ...
                    case Dialogs.DIALOG_CREATEUSERERROR:
                        this.FinishNameError(Dialogs.DIALOG_CREATEUSERERROR);
                        return;
                    case Dialogs.DIALOG_RENAMEUSERERROR:
                        this.FinishNameError(Dialogs.DIALOG_RENAMEUSERERROR);
                        return;
                    ...
                    case Dialogs.DIALOG_TIMESUP:
                        ...
                        return;
                    case Dialogs.DIALOG_STORE_PURCHASE:
                        ((StoreScreen)base.GetDialog(Dialogs.DIALOG_STORE)).PurchasePendingItem();
                        return;
                    case Dialogs.DIALOG_VISIT_TREE_OF_WISDOM:
                        ((StoreScreen)base.GetDialog(Dialogs.DIALOG_STORE)).FinishTreeOfWisdomDialog(true);
                        return;
                    case Dialogs.DIALOG_ZEN_SELL:
                        this.FinishPlantSale(true);
                        return;
                    case Dialogs.DIALOG_PURCHASE_PACKET_SLOT:
                        this.FinishPacketSlotPurchaseDialog(true);
                        return;
                    case Dialogs.DIALOG_ABOUT:
                        this.FinishAboutDialog(true);
                        return;
                    case Dialogs.RESTART_WARNING:
                        this.FinishRestartWarningDialog(true);
                        return;
                    case Dialogs.DIALOG_ACHIEVEMENT_LOCKED:
                        this.KillDialog(Dialogs.DIALOG_ACHIEVEMENT_LOCKED);
                        return;
                    case Dialogs.DIALOG_SKIP_TUTORIAL:
                        this.KillDialog(Dialogs.DIALOG_SKIP_TUTORIAL);
                        this.PreNewGame(GameMode.GAMEMODE_ADVENTURE, true, false);
                        this.mPlayerInfo.mHasFinishedTutorial = false;
                        return;
                    case (Dialogs)20008:
                        this.KillDialog((Dialogs)20008);
                        this.KillDialog(Dialogs.DIALOG_CHECKING_UPDATES);
                        return;
                    default:
                        this.KillDialog((Dialogs)backFromDialogId);
                        return;
            ...
            else if (theId % 10000 >= 3000 && theId % 10000 < 4000)  // Negative Selection
            {
                int backFromDialogId = theId - 3000;
                switch ((Dialogs)backFromDialogId)
                {
                    case Dialogs.DIALOG_PREGAME_NAG:
                        this.KillDialog(Dialogs.DIALOG_PREGAME_NAG);
                        this.Shutdown();
                        return;
                    case Dialogs.DIALOG_LOAD_GAME:
                        this.KillDialog(Dialogs.DIALOG_LOAD_GAME);
                        return;
                    case Dialogs.DIALOG_CONFIRM_IN_GAME_RESTART:
                        this.FinishInGameRestartConfirmDialog(false);
                        return;
                    case Dialogs.DIALOG_CHOOSER_WARNING:
                        KillDialog(Dialogs.DIALOG_CHOOSER_WARNING);
                    ...
                    case Dialogs.DIALOG_TIMESUP:
                        ...
                        return;
                    case Dialogs.DIALOG_VISIT_TREE_OF_WISDOM:
                        ((StoreScreen)base.GetDialog(Dialogs.DIALOG_STORE)).FinishTreeOfWisdomDialog(false);
                        return;
                    case Dialogs.DIALOG_ZEN_SELL:
                        this.FinishPlantSale(false);
                        return;
                    case Dialogs.DIALOG_MESSAGE:
                        this.KillDialog(Dialogs.DIALOG_MESSAGE);
                        this.FinishLawnDialogMessageBox(false);
                        return;
                    case Dialogs.DIALOG_PURCHASE_PACKET_SLOT:
        ...
        public override void UpdateFrames()
        {
            ...
            int numUpdates = (_drawGameFrameNumber + 1) * 100 / 60 - (_drawGameFrameNumber) * 100 / 60;
            ...
            _drawGameFrameNumber++;
            if (_drawGameFrameNumber == 60)
            {
                _drawGameFrameNumber = 0;
                _tp60f = _ticksNumber;
                _ticksNumber = 0;
            }
        ...
        public AlmanacDialog DoAlmanacDialog(SeedType theSeedType, ZombieType theZombieType, AlmanacListener theListener)
        {
            ...
            base.AddDialog(Dialogs.DIALOG_ALMANAC, almanacDialog);
        ...
        public bool KillAlmanacDialog()
        {
            ...
            this.KillDialog(Dialogs.DIALOG_ALMANAC);
            return true;
        }
        ...
        public StoreScreen ShowStoreScreen(StoreListener theListener)
        {
            ...
            base.AddDialog(Dialogs.DIALOG_STORE, storeScreen);
        ...
        public UpsellScreen ShowUpsellScreen()
        {
            ...
            base.AddDialog(Dialogs.DIALOG_UPSELL, upsellScreen);
        ...
        public void KillStoreScreen()
        {
            ...
            this.KillDialog(Dialogs.DIALOG_STORE);
        }
        ...
        public void CrazyDaveTalkMessage(string theMessage)
        {
            ...
            {
                if (theMessage[i] == '{') // original: theMessage.get_Chars(i)
                {
                    flag3 = true;
                }
                else if (theMessage[i] == '}') // original: get_Chars(
                {
                    flag3 = false;
                }
                else if (!flag3)
        ...
        public void DrawDebugInfo(GameTime gameTime)
        {
            ...
            {
                GlobalStaticVars.mGlobalContent.SetLocalizeFont(Lawn.Loc_Font.kArial);
            ...
            drawStringWithOutline(string.Format("FPS: {0:N3}", _frameCounter.AverageFramesPerSecond), new SexyColor(180, 255, 90), new SexyColor(20, 20, 20), 0, 0, 1, 1);
            drawStringWithOutline(string.Format("TP60F: {0:N3}", _tp60f), new SexyColor(180, 255, 90), new SexyColor(20, 20, 20), 120, 0, 1, 1);
            var theOverWidget = this.mWidgetManager.mOverWidget;
            bool hasOverWidget = theOverWidget != null;
            string overWidgetTypeName = hasOverWidget ? theOverWidget.GetType().Name : "None";
            string overWidgetParentTypeName = hasOverWidget && theOverWidget.mParent != null ? theOverWidget.mParent.GetType().Name : "None";
            drawStringWithOutline(string.Format("OverWidget: {0} at {1}", overWidgetTypeName, overWidgetParentTypeName), new SexyColor(180, 255, 90), new SexyColor(20, 20, 20), 0, 20, 1, 1);
        ...
        public void DrawCrazyDave(Graphics g, bool theUseSmallFont)
        {
            ...
            if (!this.mCrazyDaveMessageText.empty())
            {
                ...
                GlobalStaticVars.mGlobalContent.SetLocalizeFont(Loc_Font.kArial);
                theRect.mX -= 13;
            ...
            reanimation.Draw(g, false); // isHardwareClipRequired = false
        }
        ...
        public void PreloadForUser()
        {
            ...
            if (this.mPlayerInfo != null)
            {
                ...
                for (int j = 0; j < (int)ZombieType.NUM_ZOMBIE_TYPES; j++)
                {
                    ...
                    if (zombieType == ZombieType.ZOMBIE_BOSS || zombieType == ZombieType.ZOMBIE_CATAPULT ||
                        zombieType == ZombieType.ZOMBIE_GARGANTUAR || zombieType == ZombieType.ZOMBIE_DIGGER || zombieType == ZombieType.ZOMBIE_ZAMBONI)
                    {
                        continue;
                    }
        ...
        public int GetNumPreloadingTasks()
        {
            ...
            return numPreLoadingObjects * 68;
        }


        public void LawnMessageBox(Dialogs theDialogId, string theHeaderName, string theLinesName, string theButton1Name, string theButton2Name, int theButtonMode, LawnMessageBoxListener theListener)
        {
        ...
        public override void UpdateKeys(List<string> keynames)
        {
            Debug.OutputDebug<string>(JsonConvert.SerializeObject(keynames));
            if (keynames.Contains("F3")) 
            {
        ...
        public static string AppVersionNumber = "0.0.7.21";
        ...
        private int _ticksNumber = 0;
        private int _drawGameFrameNumber = 0;
        private int _tp60f = 0;
        private bool _showDebugScreen = false;
    }
}
