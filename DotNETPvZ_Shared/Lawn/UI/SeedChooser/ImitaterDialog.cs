...
namespace Lawn
{
	...
	internal class ImitaterDialog : LawnDialog, SeedPacketsWidgetListener
	{
		...
		{
			g.DrawImage(AtlasResources.IMAGE_SEEDCHOOSER_BACKGROUND_TOP, Constants.SeedChooserScreen_Background_Top.X- Constants.SeedChooserScreen_Background_Top.X- Constants.ImitaterDialog_ScrollWidget_ExtraWidth, Constants.ImitaterDialog_ScrollWidget_Y+ Constants.SeedChooserScreen_Background_Top.Y - Constants.SeedChooserScreen_Background_Middle.Y);
			g.DrawImage(AtlasResources.IMAGE_SEEDCHOOSER_BACKGROUND_MIDDLE, Constants.SeedChooserScreen_Background_Middle.X- Constants.SeedChooserScreen_Background_Top.X- Constants.ImitaterDialog_ScrollWidget_ExtraWidth, Constants.ImitaterDialog_ScrollWidget_Y, AtlasResources.IMAGE_SEEDCHOOSER_BACKGROUND_MIDDLE.mWidth, this.mScrollWidget.mHeight);
			g.DrawImage(AtlasResources.IMAGE_SEEDCHOOSER_BACKGROUND_BOTTOM, Constants.SeedChooserScreen_Background_Bottom.X- Constants.SeedChooserScreen_Background_Top.X- Constants.ImitaterDialog_ScrollWidget_ExtraWidth, Constants.ImitaterDialog_ScrollWidget_Y + this.mScrollWidget.mHeight);
			//base.Draw(g);
			base.DeferOverlay();
		}
		...
		public virtual void SeedSelected(SeedType theSeedType)
		{
			if (theSeedType != SeedType.SEED_NONE && !this.mApp.mSeedChooserScreen.SeedNotAllowedToPick(theSeedType))
			{
				...
				this.mApp.KillDialog((Dialogs)this.mId);
			}
		}
